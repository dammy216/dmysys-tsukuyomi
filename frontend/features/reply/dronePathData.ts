...
export const DRONE_PATH: readonly DroneKey[] = [
  ...
  // ドリーイン終わり=周回開始(旧 mid)。ここから回り込みながら寄る
  ...
  // 組み上げ完了・周回の終点(ちょうど1周。正面)
  { t: 11, turn: 1, radius: 11.5, y: 36.95, lookY: 34.95, fov: 68 },
  // 引きの着地点。真後ろへ引きつつ回転はごく僅かに続ける(1.0のまま止めると11秒で旋回が完全に停まって見える)
  ...
  // フライバイ: 外へ抜けてから低く戻る
  { t: 90, turn: 3.92, radius: 46, y: 38, lookY: 42, fov: 70 },
  { t: 96, turn: 4.22, radius: 31, y: 31, lookY: 44, fov: 72 },
  // 至近をかすめる。最後の歌詞へ向けて上昇に転じる
  { t: 101, turn: 4.48, radius: 23, y: 33, lookY: 45, fov: 76 },
