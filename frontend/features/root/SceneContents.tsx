        ...
        {replyVisible && (
          <>
            ...
            */}
            ...
            {/*
              打ち上げ花火。サビ(62秒)〜後半だけ、2小節に1発、106秒の最後の
              歌詞で大玉。例外はBメロのリザーの静けさ(ライトが消える
              60.7秒)〜サビ頭(62秒)のバラージ(ユーザー指定「ライトが
              消えるタイミングで大量の花火を上げて、サビに入ったら爆発
              させて」。ReplyFireworks.tsx の HUSH_BARRAGE_* 参照)。それ以外の
              静かな箇所(A・breath等)やアウトロ以降は上げない。
